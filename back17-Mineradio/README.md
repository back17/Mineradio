...
> 修改版说明：此工作树基于 [XxHuberrr/Mineradio](https://github.com/XxHuberrr/Mineradio) 修改，原项目版权归原作者所有，并继续按 GPL-3.0 发布。修改内容和日期见 [MODIFICATIONS.md](./MODIFICATIONS.md)。下方安装包链接仍指向原项目发布页。

## 修改版 Release

当前修改版：`v1.1.1-weather.1`

[下载 back17/Mineradio 修改版](https://github.com/back17/Mineradio/releases/tag/v1.1.1-weather.1)
...
本修改版保留原项目的 [NOTICE.md](./NOTICE.md)，并在 [MODIFICATIONS.md](./MODIFICATIONS.md) 中记录与原版的差异。
